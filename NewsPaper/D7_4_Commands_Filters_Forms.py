...
# Переходим в файл NewsPaper/news/views.py
# Фильтрация готова. С остальными полями надо быть осторожнее. Они ищут только точное совпадение. Такой вариант может не подходить для каких-нибудь интернет-магазинов, но отлично подойдёт, например, для журнала сотрудников (не наш случай).
